 ...
 * {@code traceId}/{@code spanId} that now populate the shared JSON logs. (W3C {@code traceparent}
 * propagation across the HTTP edge is Spring Boot's auto-instrumentation; the outbox→Kafka trace
 * hop is the infra-gated follow-up recorded in ADR 0010.)
 */
@SpringBootTest
