export const en = {
  ...
  landing: {
    ...
    navDemo: 'Book a demo',
    // hero
    heroBadgeCount: '5 modules',
    heroBadge: 'Restaurants, retail, car wash, services, and franchises',
    heroTitle: 'Point of sale, payroll, and financial statements in one set of books',
    heroSubtitle:
      'Every sale at the till posts straight to the journal. Payroll computes PPh 21 and BPJS from the same attendance data. Month-end close no longer means copying numbers between spreadsheets.',
    ...
    toastMeta: 'Kemang · Table 4',
    fxChip: 'daily rates',
    posOrder: 'Order #1042',
    posOutlet: 'Kemang · Table 4',
    posPaid: 'Paid',
    posItem1: 'Nasi goreng spesial',
    posItem2: 'Es teh manis',
    posItem3: 'Ayam bakar madu',
    // verticals strip
    trustLabel: 'Used across five kinds of business',
    ...
    productLede:
      'Most businesses run one cashier app, one payroll spreadsheet, and one accountant who stitches them together at month end. That is where the discrepancies creep in.',
    posCardTitle: 'A till that keeps running when the internet dies',
    posCardBody:
      'Cash sales join a local queue and upload automatically the moment the connection returns. Receipts keep printing over Bluetooth. No transaction is lost to a bad signal.',
    posPoint1: 'An offline queue for cash sales, synced automatically once back online',
    posPoint2: 'QRIS, cards, and online channels in a single payment screen',
    posPoint3: 'Bluetooth receipt printing straight from the Android app',
    ...
    f3Title: 'Receivables and payables that never slip',
    f3Body:
      'Invoice aging per customer and vendor, bank reconciliation, and collections past 90 days flagged red before they become a problem.',
    f4Title: 'One console, many outlets',
    f4Body:
      'Org structure, per-page access rights, and per-company module entitlements. Cashiers see the till; owners see everything.',
    // "Kepatuhan" — the dark compliance panel
    complianceKicker: 'Compliance',
    complianceTitle: 'Numbers you can stand behind when audited',
    complianceLede:
      'Every journal entry traces back to its source transaction. Closed periods are locked. Figures still based on provisional data are flagged, not hidden.',
    t1Title: 'A full audit trail',
    t1Body: 'Every journal line records who, when, and from which transaction.',
    t2Title: 'Locked periods',
    ...
    ctaSubtitle:
      'We import your last three months of data into a trial environment, then walk through it together for 30 minutes.',
    ...
    fPos: 'Point of sale',
    fPayroll: 'Payroll',
    fStatements: 'Financial statements',
    fArAp: 'Receivables & payables',
    fCompanyHeading: 'Company',
    fAbout: 'About us',
    fCompliance: 'Compliance',
    fSecurity: 'Security',
    fContact: 'Contact',
    fSupportHeading: 'Support',
    fDocs: 'Documentation',
  ...
  dashboardPhone: {
    ...
    fromLastWeekday: 'from last {{day}}',
    noComparison: 'No sales last {{day}} to compare against',
    weekChart: 'Net sales, last {{count}} days',
    partialLoading: 'Some outlets are still loading',
    partialFailed_one: '{{count}} outlet could not be loaded',
    partialFailed_other: '{{count}} outlets could not be loaded',
    retry: 'Retry',
    transactions: 'Transactions',
    vsLastWeekday: '{{delta}} vs last {{day}}',
    avgBill: 'Average bill',
    openBills: 'Open bills',
    openBillsValue: '{{amount}} on the floor',
    noOpenBills: 'none open',
    grossMargin: 'Gross margin',
    cogs: 'COGS {{amount}}',
    cogsPartial: 'COGS on {{costed}}/{{total}} sales',
    noCogs: 'no costed recipe yet',
    needsAction: 'Needs action',
    claimsWaiting_one: '{{count}} claim waiting for your decision',
    claimsWaiting_other: '{{count}} claims waiting for your decision',
    lowStock: 'Low stock',
    closePeriod: 'Close {{month}}',
    periodStillOpen: 'The period is still open',
    today: 'today',
    topItems: 'Top sellers today',
    sold_one: '{{count}} sold',
    sold_other: '{{count}} sold',
    error: "Could not load today's sales.",
  },
  appWelcome: {
  ...
  settings: {
    printer: {
      ...
      subtitle: 'Connect a thermal ESC/POS printer to this device to print receipts directly.',
      paperWidth: 'Paper width',
      usb: 'USB',
      usbHint: 'A thermal printer plugged in by USB (or by OTG on a tablet).',
      bluetooth: 'Bluetooth',
    ...
    tier: {
      ...
      feature: {
        ...
        accounting: 'Full accounting (invoices, bills, bank, tax, budgets, assets)',
        promotions: 'Promotions & loyalty',
        channels: 'Sales channels & settlements',
        orgStructure: 'Multi-business structure',
    ...
    payments: {
      title: 'QRIS payments',
      subtitle:
        'Choose how customers pay by QRIS at the till: mark payments as paid manually, show your own QRIS code, or connect a payment gateway for dynamic QR codes.',
      loadError: 'Could not load payment settings. Try again.',
      mode: {
        heading: 'QRIS mode',
        manual: 'Manual',
        manualDesc: 'The cashier marks a QRIS payment as paid by hand, as today. No setup needed.',
        static: 'Your own QRIS code',
        staticDesc:
          'Upload your bank or e-wallet QRIS image. The till shows it while payment is pending; the cashier still marks it as paid.',
        gateway: 'Payment gateway',
        gatewayDesc: 'Generate a fresh QR code for every sale through a connected payment gateway.',
        gatewayIdrOnly: 'Only available for companies billing in Indonesian Rupiah (IDR).',
        saveError: 'Could not save the QRIS mode. Try again.',
      },
      static: {
  ...
  statements: {
    ...
    phone: {
      ...
      retry: 'Try again',
      noData: 'No data',
      monthFailed: '{{month}} failed to load — tap to retry',
      trendFailedOne: 'One month failed to load',
      trendFailedMany: '{{count}} months failed to load',
  ...
  pos: {
    ...
    receipt: {
      ...
      splitItems: '{{paid}} of {{total}} items',
      remaining: 'Remaining',
  ...
  inventory: {
     ...
     * naming: "Inventory", items are "items" — not only food ingredients but also supplies
  ...
  inventoryPicker: {
    ...
    sheet: {
      ...
      empty: 'No ingredient matches.',
      costNone: '—',
      manage: 'Manage ingredients',
    },
  ...
  hr: {
    ...
    detail: {
      ...
      assignAnother: 'Assign to another unit',
      endAssignment: 'End',
      since: 'since {{date}}',
      compensation: 'Compensation',
      compChange: 'Change compensation',
      compHint: 'Amounts are always masked in the console.',
  ...
  menu: {
    ...
    // ADR 0083 — the phone work page.
    phone: {
      addItem: 'Item',
      searchPlaceholder: 'Search items or ingredients',
      all: 'All',
      summary: '{{active}} active items · {{soldOut}} marked sold out · average margin {{margin}}',
      summaryNoMargin: '{{active}} active items · {{soldOut}} marked sold out',
      ...
      hppLabel: 'COGS from recipe',
      availableTitle: 'Available at the till',
      availableOn: 'Shown on the till and in ordering',
      availableOff: 'Hidden from the till',
      recipeHeading: 'Recipe',
      costNone: '—',
      costPartial: 'some ingredients have no cost yet',
      duplicate: 'Duplicate',
      copySuffix: '(copy)',
      deleteItem: 'Delete item',
      appliesNote: 'Price and availability changes apply at the till immediately — nothing to save.',
      duplicateNote: 'A copy carries the recipe, not the modifier options.',
      noMatch: 'No item matches the search.',
      empty: 'No menu items yet — add the first one.',
      newItem: 'New item',
      categoryCustom: 'Other category…',
      categoryCustomPlaceholder: 'Category name',
      qtyTitle: 'Quantity per portion',
      qtyHint: 'in {{unit}}',
      qtyInvalid: 'Enter a quantity above zero.',
      pickIngredient: 'Add ingredient',
      pickSearch: 'Search ingredients',
  ...
  ap: {
    ...
    newBill: {
      // ADR 0084 — the phone "Tagihan baru" work form.
      phone: {
        draft: 'Draft',
        vendorSection: 'Vendor',
        pickVendor: 'Choose a vendor',
        vendorNotChosen: 'Not chosen yet',
        npwp: 'Tax ID {{id}}',
        noNpwp: 'no tax ID',
        termsDays: 'terms {{days}} days',
        termsCash: 'cash on delivery',
        ...
        duplicate: 'This number is already recorded for {{vendor}}. Check before continuing.',
        invoiceDate: 'Invoice date',
        dueDate: 'Due date',
        termsLabel: 'Terms',
        termCash: 'Cash',
        termDays: '{{days}} days',
        dueHintCash: 'This vendor is paid in cash on delivery.',
        dueHint: 'Paid {{days}} days after the invoice date, on {{date}}.',
        linesSection: 'Line items',
        lineCount_one: '{{count}} line · {{subtotal}}',
        lineCount_other: '{{count}} lines · {{subtotal}}',
        linePlaceholder: 'Item or service name',
        receiptNamePlaceholder: 'Name on the receipt (optional)',
        removeLine: 'Remove line',
        accountLabel: 'Expense account',
        accountExpense: '5000 · General expense',
        ...
        vat: 'VAT',
        total: 'Bill total',
        printedTitle: 'Amount printed on the invoice',
        reconEmpty: 'Enter the total printed on the paper invoice so it can be checked.',
        reconMatch: 'Matches the computed total.',
        reconHigher:
          'The invoice is {{amount}} higher than the computed total. Check unit prices, the discount, or the VAT rate.',
        reconLower:
          'The invoice is {{amount}} lower than the computed total. Check unit prices, the discount, or the VAT rate.',
        evidenceSection: 'Evidence and notes',
        attach: 'Attach the invoice',
        attachHint: 'Photo or PDF — required for audit',
        attachRemove: '{{size}} · tap to remove',
        attachError: 'That file could not be attached. Try a photo or a PDF under 5 MB.',
        noteLabel: 'Internal note',
        notePlaceholder: 'e.g. one box short, confirmed with the sales rep',
        checklistTitle: 'Still to complete · {{count}}',
        ready: 'Ready to save',
        allDone: 'All set. The bill is ready to be recorded to payables.',
        issue: {
          vendor: 'Choose a vendor',
          invoiceNumber: 'Enter the invoice number',
          duplicate: 'This invoice number is already recorded for the same vendor',
          noLines: 'Add at least one line item',
          unnamed_one: '{{count}} line has no item name',
          unnamed_other: '{{count}} lines have no item name',
          unpriced_one: '{{count}} line has no quantity or price',
          unpriced_other: '{{count}} lines have no quantity or price',
          printed: 'Enter the amount printed on the invoice to check against',
          mismatch: '{{amount}} difference against the printed amount',
          attachment: 'Attach a photo or PDF of the invoice',
        },
        footerTotal: 'Total',
        save: 'Save bill',
        saving: 'Saving…',
        saved: 'Saved',
        failed: 'The bill could not be saved. Try again.',
        uploadFailed:
          'The bill was saved as a draft, but the attachment failed to upload — try again.',
        retryUpload: 'Retry upload',
        postFailed:
          'The bill was saved as a draft but could not be posted — open it to try again.',
  ...
  bank: {
    accounts: {
      ...
      createDialog: {
        ...
        bankNameLabel: 'Bank (optional)',
        bankNamePlaceholder: 'Select a bank…',
        bankNameOther: 'Other…',
        bankNameOtherLabel: 'Bank name',
