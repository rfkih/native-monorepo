export const en = {
  ...
  serviceCatalog: {
    ...
    subtitle: 'Manage the packages, add-ons, and washers this outlet offers.',
  ...
  posVertical: {
    ...
    body: 'This outlet belongs to a {{vertical}} business unit. Sales, menus, and kitchen tickets currently support restaurant and car wash outlets only.',
