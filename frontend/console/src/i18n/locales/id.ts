...
export const id = {
  ...
  dashboardPhone: {
    ...
    dateLine: '{{date}} · {{outlets}}',
    menu: 'Menu',
    todayRevenue: 'Omzet hari ini',
    fromLastWeekday: 'dari {{day}} lalu',
    noComparison: 'Belum ada pembanding dari {{day}} lalu',
    weekChart: 'Penjualan bersih, {{count}} hari terakhir',
    partialLoading: 'Sebagian outlet masih dimuat',
    partialFailed_one: '{{count}} outlet gagal dimuat',
    partialFailed_other: '{{count}} outlet gagal dimuat',
    retry: 'Coba lagi',
    transactions: 'Transaksi',
    vsLastWeekday: '{{delta}} vs {{day}} lalu',
    avgBill: 'Rata-rata bill',
    openBills: 'Bill terbuka',
    openBillsValue: '{{amount}} berjalan',
    noOpenBills: 'tidak ada yang terbuka',
    grossMargin: 'Margin kotor',
    cogs: 'HPP {{amount}}',
    cogsPartial: 'HPP {{costed}}/{{total}} transaksi',
    noCogs: 'belum ada resep berbiaya',
    needsAction: 'Perlu tindakan',
    claimsWaiting_one: '{{count}} klaim menunggu keputusan Anda',
    claimsWaiting_other: '{{count}} klaim menunggu keputusan Anda',
    lowStock: 'Stok menipis',
    closePeriod: 'Tutup buku {{month}}',
    periodStillOpen: 'Periode masih terbuka',
    today: 'hari ini',
    topItems: 'Terlaris hari ini',
    sold_one: '{{count}} terjual',
    sold_other: '{{count}} terjual',
    error: 'Tidak dapat memuat penjualan hari ini.',
  },
  appWelcome: {
  ...
  statements: {
    ...
    phone: {
      ...
      monthFailed: '{{month}} gagal dimuat — ketuk untuk coba lagi',
      trendFailedOne: 'Satu bulan gagal dimuat',
      trendFailedMany: '{{count}} bulan gagal dimuat',
  ...
  inventory: {
    ...
    packSizeHint: 'Berapa {{unit}} biasanya isi satu kemasan — mengisi otomatis "Isi per kemasan" di baris pembelian untuk bahan ini. Kosongkan jika tidak ada bawaan.',
  ...
  inventoryPicker: {
    // The shared catalog picker sheet (ADR 0083 menu recipe, ADR 0084 bill line).
    sheet: {
      title: 'Tambah bahan',
      search: 'Cari bahan',
  ...
  menu: {
    ...
    // ADR 0083 — halaman kerja di ponsel.
    phone: {
      addItem: 'Item',
      searchPlaceholder: 'Cari item atau bahan',
      all: 'Semua',
      summary: '{{active}} item aktif · {{soldOut}} ditandai habis · margin rata-rata {{margin}}',
      summaryNoMargin: '{{active}} item aktif · {{soldOut}} ditandai habis',
      ingredients_one: '{{count}} bahan',
      ingredients_other: '{{count}} bahan',
      stockUntracked: 'stok tak dilacak',
      stockZero: 'stok 0',
      ...
      hppLabel: 'HPP dari resep',
      availableTitle: 'Tersedia di kasir',
      availableOn: 'Muncul di layar kasir dan pemesanan',
      availableOff: 'Disembunyikan dari kasir',
      recipeHeading: 'Resep',
      costNone: '—',
      costPartial: 'sebagian bahan belum punya biaya',
      duplicate: 'Duplikat',
      copySuffix: '(salinan)',
      deleteItem: 'Hapus item',
      appliesNote: 'Perubahan harga dan ketersediaan berlaku langsung di kasir — tidak perlu disimpan.',
      duplicateNote: 'Salinan membawa resepnya, bukan opsi tambahannya.',
      noMatch: 'Tidak ada item yang cocok dengan pencarian.',
      empty: 'Belum ada item menu — tambahkan yang pertama.',
      newItem: 'Item baru',
      categoryCustom: 'Kategori lain…',
      categoryCustomPlaceholder: 'Nama kategori',
      qtyTitle: 'Jumlah per porsi',
      qtyHint: 'dalam {{unit}}',
      qtyInvalid: 'Masukkan jumlah lebih dari nol.',
      pickIngredient: 'Tambah bahan',
      pickSearch: 'Cari bahan',
  ...
  ap: {
    vendors: {
      ...
      noValue: '—',
      createDialog: {
        termsLabel: 'Termin pembayaran (hari)',
        title: 'Pemasok baru',
        nameLabel: 'Nama',
        emailLabel: 'Email (opsional)',
        taxIdLabel: 'NPWP (opsional)',
    ...
    newBill: {
      // ADR 0084 — formulir kerja "Tagihan baru" di ponsel.
      phone: {
        draft: 'Draf',
        vendorSection: 'Vendor',
        pickVendor: 'Pilih vendor',
        vendorNotChosen: 'Belum dipilih',
        npwp: 'NPWP {{id}}',
        noNpwp: 'tanpa NPWP',
        termsDays: 'termin {{days}} hari',
        termsCash: 'termin tunai',
        outstanding: 'utang berjalan {{amount}}',
        noOutstanding: 'tidak ada utang berjalan',
        addVendor: 'Tambah vendor',
        invoiceSection: 'Detail faktur',
        invoiceNumber: 'Nomor faktur',
        invoiceNumberPlaceholder: 'INV/2026/09/…',
        duplicate: 'Nomor ini sudah dicatat untuk {{vendor}}. Periksa sebelum melanjutkan.',
        invoiceDate: 'Tanggal faktur',
        dueDate: 'Jatuh tempo',
        termsLabel: 'Termin',
        termCash: 'Tunai',
        termDays: '{{days}} hari',
        dueHintCash: 'Vendor ini dibayar tunai saat barang diterima.',
        dueHint: 'Dibayar {{days}} hari setelah tanggal faktur, yaitu {{date}}.',
        linesSection: 'Baris item',
        lineCount_one: '{{count}} baris · {{subtotal}}',
        lineCount_other: '{{count}} baris · {{subtotal}}',
        linePlaceholder: 'Nama barang atau jasa',
        receiptNamePlaceholder: 'Nama di nota (opsional)',
        removeLine: 'Hapus baris',
        accountLabel: 'Akun biaya',
        accountExpense: '5000 · Beban umum',
        ...
        vat: 'PPN',
        total: 'Total tagihan',
        printedTitle: 'Nilai tercetak di faktur',
        reconEmpty: 'Isi nilai total yang tertera di kertas faktur agar bisa dicocokkan.',
        reconMatch: 'Cocok dengan hitungan sistem.',
        reconHigher:
          'Faktur {{amount}} lebih tinggi dari hitungan sistem. Periksa harga satuan, diskon, atau tarif PPN.',
        reconLower:
          'Faktur {{amount}} lebih rendah dari hitungan sistem. Periksa harga satuan, diskon, atau tarif PPN.',
        evidenceSection: 'Bukti dan catatan',
        attach: 'Lampirkan faktur',
        attachHint: 'Foto atau PDF, wajib untuk audit',
        attachRemove: '{{size}} · ketuk untuk melepas',
        attachError: 'Berkas itu tidak bisa dilampirkan. Coba foto atau PDF di bawah 5 MB.',
        noteLabel: 'Catatan internal',
        notePlaceholder: 'Mis. barang diterima kurang 1 dus, sudah dikonfirmasi ke sales',
        checklistTitle: 'Sisa yang harus dilengkapi · {{count}}',
        ready: 'Siap disimpan',
        allDone: 'Semua lengkap. Tagihan siap dicatat ke buku utang.',
        issue: {
          vendor: 'Pilih vendor',
          invoiceNumber: 'Isi nomor faktur',
          duplicate: 'Nomor faktur ini sudah pernah dicatat untuk vendor yang sama',
          noLines: 'Tambahkan minimal satu baris item',
          unnamed_one: '{{count}} baris belum diberi nama barang',
          unnamed_other: '{{count}} baris belum diberi nama barang',
          unpriced_one: '{{count}} baris belum punya jumlah atau harga',
          unpriced_other: '{{count}} baris belum punya jumlah atau harga',
          printed: 'Isi nilai yang tercetak di faktur untuk dicocokkan',
          mismatch: 'Selisih {{amount}} terhadap nilai tercetak',
          attachment: 'Lampirkan foto atau PDF faktur',
        },
        footerTotal: 'Total',
        save: 'Simpan tagihan',
        saving: 'Menyimpan…',
        saved: 'Tersimpan',
        failed: 'Tagihan tidak tersimpan. Coba lagi.',
        uploadFailed: 'Tagihan tersimpan sebagai draf, tapi lampiran gagal diunggah — coba lagi.',
        retryUpload: 'Coba unggah lagi',
        postFailed:
          'Tagihan tersimpan sebagai draf tapi belum bisa diposting — buka untuk mencoba lagi.',
        openDraft: 'Buka draf',
      },
      title: 'Tagihan baru',
  ...
  salesIntegrity: {
    ...
    coverage: {
      ...
      manualCorrections: 'Koreksi stok manual periode ini: {{n}}',
    },
    ...
    signal: {
      ...
      PERSISTENT_CASH_SHORT: {
        ...
        body: 'Closing dengan hitungan laci kurang: {{n}}',
        advice:
      ...
      UNEXPLAINED_CASH_OVER: {
        ...
        body: 'Closing dengan hitungan laci lebih: {{n}}',
        advice:
      ...
      SESSION_LEFT_OPEN: {
        ...
        body: 'Sesi yang tidak pernah ditutup: {{n}}',
        advice:
