...
export const id = {
  ...
  stocktake: {
    ...
    entryHint:
      'Jumlah terisi otomatis dengan kuantitas sistem — ubah hanya yang berbeda dari hasil hitung fisik Anda. Sebelum ada resep, selisih barang berbiaya juga mencakup pemakaian normal, bukan hanya kehilangan.',
