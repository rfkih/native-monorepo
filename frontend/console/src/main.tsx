...
createRoot(document.getElementById('root')!).render(
  <StrictMode>
    {/* Outermost on purpose: a crash anywhere below (providers included) must show the recover
        screen, never a blank page — the Android shells have no reload affordance of their own. */}
    <ErrorBoundary>
