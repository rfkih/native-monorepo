...
export function Dashboard() {
  ...
  // ADR 0070: outlets hang directly off the company, so there is no level to roll them UP into —
  // the per-outlet panel below is both the finest and the coarsest view there is. Rolling several
  // COMPANIES together is group consolidation's job, not the dashboard's.
