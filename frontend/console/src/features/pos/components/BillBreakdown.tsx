  ...
  return (
    <div className="space-y-2 text-sm">
      <div className="flex items-baseline justify-between">
        <span className="text-2xs text-ink-3">{t('pos.subtotal')}</span>
      ...
      {breakdown.discountMinor > 0 ? (
        <div className="flex items-baseline justify-between">
          <span className="text-2xs text-ink-3">{t('pos.discount')}</span>
      ...
      <div className="flex items-baseline justify-between">
        <span className="text-2xs text-ink-3">{t('pos.serviceCharge')}</span>
        <span className="tnum font-mono text-ink">
          {formatMoney(breakdown.serviceChargeMinor, currency, locale)}
        </span>
      </div>
      <div className="flex items-baseline justify-between">
        <span className="text-2xs text-ink-3">{t('pos.tax')}</span>
        <span className="tnum font-mono text-ink">
      ...
      <div className="flex items-baseline justify-between border-t border-line pt-2">
        ...
        <span className="tnum font-mono text-2xl font-bold leading-none text-ink">
