        ...
        <>
          ...
          <label className="relative hidden lg:block">
            ...
            <input
              ...
              className="h-[38px] w-[250px] rounded-[11px] border border-line bg-surface pl-9 pr-3 text-sm text-ink placeholder:text-ink-400 focus:border-emerald focus:outline-none focus:ring-4 focus:ring-emerald/15"
            />
          </label>
