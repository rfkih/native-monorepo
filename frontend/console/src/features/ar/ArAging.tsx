...
function BucketStrip({
  ...
  return (
    <div className="flex overflow-hidden rounded-2xl border border-line bg-surface max-sm:overflow-x-auto">
      {values.map((v, i) => (
        <div
          key={BUCKET_KEYS[i]}
          className={cn(
        ...
        >
          <div className="truncate text-2xs font-semibold uppercase tracking-eyebrow opacity-70">
            {labels[i]}
          </div>
          <div className="tnum mt-1.5 truncate font-mono text-lg font-bold">
