 ...
 * (MobileTabBarGate owns that policy). EVERY tab is a route and derives its active state from the
 * location — the action-tab shape (`onSelect`/`active`, rendering a <button>) existed only for the
 * "More" sheet, and went away with it when More became a screen (ADR 0078).
 *
