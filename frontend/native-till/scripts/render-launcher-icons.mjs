// Render the LEGACY raster launcher icons for the Business app, at every density.
//
...
// `android/app/src/main/res/drawable/ic_launcher_{bg_brand,fg_brand}.xml`.
//
...
//
// Run from frontend/native-till:  node scripts/render-launcher-icons.mjs   (npm run icons)
...
// The BRAND glyph — the upward trend line (console Wordmark.tsx BrandMark), mirroring
// drawable/ic_launcher_fg_brand.xml. The Employee app uses a person glyph instead, so the two apps
// stay tellable apart on a phone that has both installed.
const GLYPH = `<path d="M4 18 L10 10 L14 14 L20 5"/>`
