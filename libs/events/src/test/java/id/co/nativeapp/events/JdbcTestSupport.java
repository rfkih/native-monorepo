 ...
 *
 * <p>Each test gets a fresh in-memory database with the outbox/processed_event DDL applied, plus
 * a {@link JdbcTemplate}, a {@link TransactionTemplate}, and the collaborators under test wired
 * to that database. Using PostgreSQL mode keeps the SQL (UUID, BYTEA, TIMESTAMP WITH TIME ZONE)
...
abstract class JdbcTestSupport {
    ...
    void setUpDatabase() {
        ...
        String url =
                "jdbc:h2:mem:events_" + System.nanoTime()
