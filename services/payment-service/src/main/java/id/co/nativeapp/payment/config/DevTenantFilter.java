...
/**
 * Request-edge tenant binding — a minimal DEV stand-in for the JWT/gateway. Ported verbatim from
 * barbershop-service's {@code DevTenantFilter}.
 *
 ...
 * {@code company_id} column is {@code UUID}; a non-UUID tenant id would persist a member and then
