 ...
 * ({@link KafkaConfig}) treats this as non-retryable and routes the record to {@code
 * ConsolidationClosed.DLT}, rather than synthesising a non-durable id (which would defeat dedupe
 * after a rebalance / compacted replay and risk creating a duplicate notification — HR-3).
 */
