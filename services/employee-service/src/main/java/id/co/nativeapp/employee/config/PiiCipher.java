...
/**
 * AES-256-GCM authenticated encryption for PII columns (rule 6). One instance holds the 256-bit key
 * sourced from {@link PiiEncryptionProperties}; {@link PiiAttributeConverter} delegates to it so
 * the NIK and bank-account columns are ciphertext at rest and decrypt back transparently on read.
 *
