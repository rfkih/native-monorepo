 ...
 * Applied explicitly via {@code @Convert(converter = PiiAttributeConverter.class)} on the {@code
 * nik} and {@code bank_account} entity fields, it encrypts on write ({@link
