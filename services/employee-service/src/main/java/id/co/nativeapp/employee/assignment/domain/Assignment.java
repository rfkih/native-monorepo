 ...
 * id.co.nativeapp.employee.employee.domain.Employee employee} (ARCHITECTURE.md §2): an employee
 * holds multiple <em>concurrent</em> assignments, and all concurrent assignments MUST resolve to
 * the same {@code legal_employer} (enforced in {@link AssignmentWriter} against the local org read
 * model).
 *
