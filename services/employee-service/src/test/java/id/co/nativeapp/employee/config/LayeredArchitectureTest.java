...
class LayeredArchitectureTest {
  ...
  private static final String BASE_PACKAGE = "id.co.nativeapp.employee";
   ...
   * the sink (accessed by all, accesses none of these); projection holds native-query read models
   * produced by the repository and consumed (mapped to a dto) by the service. {@code
