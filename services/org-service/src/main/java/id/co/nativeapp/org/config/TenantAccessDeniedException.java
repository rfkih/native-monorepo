 ...
 * the authenticated tenant). The {@link TenantAccessDeniedAdvice} maps it to a {@code 403
 * Forbidden} RFC 7807 {@code ProblemDetail}; the request is rejected, never silently accepted
