 ...
 *
 * <p>Copied verbatim from the service-template / restaurant-service shape (M1.2). A later task
 * promotes this into a {@code libs/tenant} auto-configuration; until then every service carries its
 * own copy so the rule-5 guarantee holds without a shared dependency the libraries do not yet
 * provide.
 */
@Configuration
