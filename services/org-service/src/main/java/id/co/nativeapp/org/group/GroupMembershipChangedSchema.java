 ...
 * id.co.nativeapp.org.company.OrgUnitChangedSchema}). The schema is the single source of truth
 * registered in {@code docs/EVENT-CATALOG.md}; this class parses it once and projects a {@link
 * GroupMembership} plus the {@link GroupMembershipChangeKind} onto it.
 *
