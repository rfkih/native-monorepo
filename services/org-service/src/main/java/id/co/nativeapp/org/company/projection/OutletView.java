 ...
 * /api/v1/outlets}).
 *
 * <p>Only the columns the picker needs are selected — {@code id}, {@code name}, and the parent
 * business unit's {@code vertical} (joined in; outlet rows themselves store NULL, and the alias may
 * be null for an anomalous parentless outlet). Lives in the feature's {@code projection} package
