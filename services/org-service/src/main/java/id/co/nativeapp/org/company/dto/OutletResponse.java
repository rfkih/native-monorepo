 ...
 * display {@code name}, and the parent business unit's {@code vertical} — the POS gates its
 * surfaces on it (cashiers cannot read the dashboard-only org-units endpoint). Mapped from the
 * {@link id.co.nativeapp.org.company.projection.OutletView} projection in the service layer — never
 ...
 */
public record OutletResponse(UUID id, String name, String vertical) {}
