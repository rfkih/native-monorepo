-- loyalty-service V2 — error_log ops table (ADR 0005 pilot -> ADR 0009 fleet rollout: error-inbox +
-- webhook alerting). Copied verbatim from barbershop-service's V2__error_log.sql.
--
...
--      masked — which also covers a member phone number, should one ever leak into an exception
--      message).
