 ...
 * restaurant-service, and {@code /api/v1/revenue/**} to finance-service. Targets default to the
...
public record GatewayRouteProperties(
    @NotNull URI orgService, @NotNull URI restaurantService, @NotNull URI financeService) {}
