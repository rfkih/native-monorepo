...
/**
 * Producer-side contract test for the {@code GiftCardSold} event (ADR 0027, Phase 4) — ported from
 * carwash-service's {@code GiftCardSoldContractTest} (restaurant-service's {@code
 * SaleRecordedContractTest} per-service pattern). barbershop-service is one of THREE producers
 * sharing the one stable {@code id.co.nativeapp.events.restaurant} namespace (EVENT-CATALOG.md
 * "namespace decision").
 */
