 ...
 * docs/EVENT-CATALOG.md) — so barbershop reads the producer's bytes and the back-compat gate
...
class EntitlementConsumerContractTest {
  ...
  void grantedRoundTripsAndDecodesToEntitledTrue() {
    ...
    record.put("module_key", "barbershop");
    ...
    assertThat(decoded.moduleKey()).isEqualTo("barbershop");
