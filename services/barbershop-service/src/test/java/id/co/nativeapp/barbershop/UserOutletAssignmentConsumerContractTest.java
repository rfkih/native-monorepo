 ...
 * naming convention barbershop-service already uses for its other consumed-event contract tests
 * ({@code StaffConsumerContractTest}, {@code EntitlementConsumerContractTest}) — ported and renamed
 * from carwash-service's {@code UserOutletAssignmentChangedContractTest}.
 *
 ...
 *       id.co.nativeapp.barbershop.outletref.messaging.UserOutletAssignmentListener} takes off the
 *       wire.
 *   <li>The consumer schema is BACKWARD-COMPATIBLE with the producer schema (docs/EVENT-CATALOG.md
 *       anchor): a barbershop reader can decode bytes the org-service producer wrote.
