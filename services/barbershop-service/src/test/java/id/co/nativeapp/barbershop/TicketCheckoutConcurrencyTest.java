 ...
 * mirroring carwash-service's {@code TicketCheckoutConcurrencyTest}: two threads check out with the
 * SAME {@code idempotencyKey} in the SAME tenant scope, the company being entitled to the
 * barbershop module.
 *
 ...
 * barbershop_ticket} row, exactly ONE {@code SaleRecorded} outbox row, and BOTH callers receive a
