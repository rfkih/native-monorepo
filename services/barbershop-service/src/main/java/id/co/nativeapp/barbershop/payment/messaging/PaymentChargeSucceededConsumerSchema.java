...
/**
 * Loads barbershop-service's CONSUMER copy of the {@code PaymentChargeSucceeded} Avro schema from
 * the classpath ({@code avro/PaymentChargeSucceeded.avsc}, the single {@code libs/contracts} source
 * of truth, ADR 0003/0045) and decodes raw Avro bytes into a {@link PaymentChargeSucceededEvent}.
 * Mirrors carwash-service's {@code PaymentChargeSucceededConsumerSchema} EXACTLY.
 */
