 ...
 * user_outlet_assignment_ref} read model (ported verbatim from carwash-service's {@code outletref}
 * feature).
 *
  ...
  public boolean apply(UserOutletAssignmentEvent event) {
    ...
    try {
      return TenantContext.callAs(
          event.companyId(), "barbershop-outlet-consumer", () -> writer.apply(event));
