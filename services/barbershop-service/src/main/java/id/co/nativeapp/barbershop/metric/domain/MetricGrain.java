 ...
 * vertical cannot emit. barbershop declares the {@link #OUTLET} grain for its service_count metric,
 * and the {@link #EMPLOYEE} grain for its conditional sales_amount metric.
 */
