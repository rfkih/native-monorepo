...
public class BarbershopTicket extends Auditable {
   ...
   * loyaltyRedeemedMinor}) so the extended {@code barbershop_ticket} CHECK constraint balances. See
   ...
   * rebuild the COMBINED discount {@code TaxChargeService.resolve} was originally called with.
   */
