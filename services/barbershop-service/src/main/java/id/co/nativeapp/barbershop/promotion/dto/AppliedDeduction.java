...
/**
 * One deduction {@link id.co.nativeapp.barbershop.promotion.service.PromotionEngineService
 ...
 * there — a manual discount is not a rule). Ported verbatim from restaurant-service via
 * carwash-service.
 *
 * @param ruleId the {@link id.co.nativeapp.barbershop.promotion.domain.PromoRule} id, or {@code
 ...
 *     id.co.nativeapp.barbershop.promotion.service.PromotionEngineService PromotionEngineService}'s
