...
/**
 * One deduction {@link id.co.nativeapp.barbershop.promotion.service.PromotionEngineService PromotionEngineService}
 ...
 * not a rule). Ported verbatim from restaurant-service via carwash-service.
 *
 * @param ruleId the {@link id.co.nativeapp.barbershop.promotion.domain.PromoRule} id, or {@code null}
 *     for the manual discount
 * @param couponId the {@link id.co.nativeapp.barbershop.promotion.domain.Coupon} that gated this
 ...
 *     id.co.nativeapp.barbershop.promotion.service.PromotionEngineService PromotionEngineService}'s sequential
