 ...
 * — the outlet-scoping-enforcement fault shape ported from carwash-service's {@code
 ...
 *
 * <p>Emitted by {@link id.co.nativeapp.barbershop.outletref.service.OutletAccessGuard} when a
 ...
 * exist in the tenant) — matching carwash-service's identical handler.
 */
