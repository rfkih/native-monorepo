 ...
 *       id.co.nativeapp.barbershop.promotion.domain.PromoRuleType}).
 * </ul>
 *
 ...
 *     ({@code CATEGORY} is schema-legal but never matches for barbershop — no category dimension)
 * @param scopeRefId the {@code service_item}/{@code service_addon} id; required for {@code
 *     PERCENT_OFF_LINE} only
