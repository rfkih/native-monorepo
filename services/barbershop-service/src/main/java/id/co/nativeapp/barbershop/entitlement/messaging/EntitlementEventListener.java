 ...
 * id.co.nativeapp.barbershop.entitlement.domain.EntitlementProjection}) — the projection every
 * catalog/ticket write is checked against (the "real gating in the verticals", Phase-2; rule 2 — a
 ...
 * id.co.nativeapp.barbershop.entitlement.service.EntitlementProjectionWriter}. A record arriving
