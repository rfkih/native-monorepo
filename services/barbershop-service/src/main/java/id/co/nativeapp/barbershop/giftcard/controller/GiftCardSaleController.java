package id.co.nativeapp.barbershop.giftcard.controller;
...
@RestController
@RequestMapping("/api/v1/barbershop/gift-cards")
  ...
  public ResponseEntity<GiftCardSaleResponse> sell(
    ...
    return result.created()
        ? ResponseEntity.created(
                URI.create("/api/v1/barbershop/gift-cards/" + body.giftCardSaleId()))
            .body(body)
