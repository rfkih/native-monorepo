 ...
 * (V3__promotions.sql), unique on {@code (company_id, code)} where {@code code} is uppercase-
 * normalized by the service before insert/lookup. Ported verbatim from restaurant-service via
 * carwash-service.
 *
