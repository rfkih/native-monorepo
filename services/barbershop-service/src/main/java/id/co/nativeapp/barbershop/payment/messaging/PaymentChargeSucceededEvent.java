 ...
 * barbershop-service is one of three verticals on this topic ({@code restaurant}, {@code carwash},
 ...
 * are not barbershop's. Mirrors carwash-service's {@code PaymentChargeSucceededEvent} EXACTLY.
 *
 ...
 *     {@code barbershop} is acted on here
 * @param paymentId the vertical's payment row id — barbershop's verification anchor (barbershop
 *     captures by TICKET id, carried in {@link #referenceId()}, not by this field)
