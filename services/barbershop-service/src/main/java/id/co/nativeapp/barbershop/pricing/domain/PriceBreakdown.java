 ...
 * barbershop checkout (ported from carwash-service's {@code pricing} feature — the SME note below
 * is barbershop-specific).
 *
 ...
 *
 * <p><strong>SME NOTE: the barbershop tax regime is ILLUSTRATIVE only</strong> — whether a
 * barbershop / personal-care sale is subject to PPN (national VAT) or a regional service/
 * entertainment tax, and whether a service charge applies, is not yet confirmed by an accounting +
 * tax SME (see {@link RuleProvenance}).
 *
