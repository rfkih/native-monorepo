...
/**
 * {@code GET /api/v1/barbershop/pricing/effective-rules} — Phase 5 (ADR 0028) offline-mode
 * support: the currently-effective tax/service-charge basis-point rates the POS device caches so
 * it can price a queued offline sale with the SAME formula the server applies on replay. Ported
 * verbatim from carwash-service (ADR 0024).
 *
