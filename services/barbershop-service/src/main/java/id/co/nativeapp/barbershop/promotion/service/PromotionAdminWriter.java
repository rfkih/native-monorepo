...
import id.co.nativeapp.barbershop.promotion.domain.Coupon;
import id.co.nativeapp.barbershop.promotion.domain.PromoRule;
 ...
 * {@code CatalogWriter} pattern). Ported verbatim from restaurant-service via carwash-service.
 *
