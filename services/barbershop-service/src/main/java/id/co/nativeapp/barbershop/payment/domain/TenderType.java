...
/**
 * How a {@link BarbershopPayment} was tendered (ported verbatim from carwash-service's {@code
 * payment} feature).
 *
 ...
 * barbershop_payment.tender_type} column is human-readable and stable against reordering.
 */
