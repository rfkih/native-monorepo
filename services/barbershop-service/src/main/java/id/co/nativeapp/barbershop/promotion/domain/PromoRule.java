 ...
 * resolves at checkout/quote time. Maps to the {@code promo_rule} table (V3__promotions.sql).
 * Ported verbatim from restaurant-service via carwash-service (identical DDL, identical entity
 * shape).
 *
