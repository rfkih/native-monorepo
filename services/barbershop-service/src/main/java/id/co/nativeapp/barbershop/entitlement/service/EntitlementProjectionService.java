 ...
 * {@link TenantContext#callAs} with a fixed {@code "barbershop-entitlement-consumer"} actor (which
...
public class EntitlementProjectionService {
  ...
  public static final String CONSUMER_ACTOR = "barbershop-entitlement-consumer";
