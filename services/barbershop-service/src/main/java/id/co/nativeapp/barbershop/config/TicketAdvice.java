 ...
 * {@link OutletAccessAdvice}'s style in this same package. Unknown/inactive/cross-business item, a
 * missing barber, and a cash short-tender ride the shared {@code IllegalArgumentException → 400}
 * (or bean-validation {@code 400}) mapping already.
 *
 * <ul>
