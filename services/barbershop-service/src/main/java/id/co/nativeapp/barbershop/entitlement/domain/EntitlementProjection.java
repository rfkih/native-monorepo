 ...
 * barbershop-service maintains this projection by CONSUMING {@code EntitlementGranted}/{@code
 ...
 * id.co.nativeapp.barbershop.entitlement.service.ProjectionEntitlementLoader} the shared {@code
 * libs/entitlement-check} cache consults on a miss, so the checkout gate can answer "is this
 * company entitled to barbershop?" without a sync call.
 *
