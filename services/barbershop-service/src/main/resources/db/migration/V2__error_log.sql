-- barbershop-service V2 — error_log ops table (ADR 0005 pilot -> ADR 0009 fleet rollout:
-- error-inbox + webhook alerting). Copied verbatim from carwash-service's V2__error_log.sql.
--
