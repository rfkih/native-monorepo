-- barbershop-service V6 — go-live: supersede the illustrative tax rule with the OFFICIAL rule
-- (ADR 0042).
--
-- ============================================================================================================================
...
-- ILLUSTRATIVE_PLACEHOLDER row seeded by V1:
--   VAT_BARBERSHOP: rate_bp 1100 (11%), service_charge_in_tax_base TRUE — UNCHANGED.
--
...
-- change is required.
--
-- The V1 ILLUSTRATIVE_PLACEHOLDER row is left in place as an audit trail — it is NOT deleted or
-- deactivated, matching the "REPLACE VIA HIGHER-VERSION DATA" guidance already documented in V1.
-- ============================================================================================================================
...
-- SET LOCAL alone is sufficient, exactly as V1 does it.
SET LOCAL app.current_tenant = '11111111-1111-1111-1111-111111111111';

-- VAT_BARBERSHOP: 11% (1100 bp) — OFFICIAL, confirmed for go-live. Rate unchanged from V1.
