...
import id.co.nativeapp.carwash.promotion.domain.PromoRule;
 ...
 * RlsAutoApplyAspect} that sets the tenant GUC only engage through the proxy ({@code TicketWriter}/
 * {@code CatalogWriter} pattern). Ported verbatim from restaurant-service.
 *
