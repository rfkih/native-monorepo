...
import id.co.nativeapp.carwash.staff.service.StaffProjectionService;
 ...
 * local staff read model ({@link id.co.nativeapp.carwash.staff.domain.Staff}) so the vertical knows
 * its staff (rule 2 — a cached read model, never a sync call).
 *
 ...
 * id.co.nativeapp.carwash.staff.service.StaffProjectionWriter}. A record arriving WITHOUT a valid
 * {@code id} header fails closed (see {@link #eventIdOf}) so it is DLT'd.
 *
