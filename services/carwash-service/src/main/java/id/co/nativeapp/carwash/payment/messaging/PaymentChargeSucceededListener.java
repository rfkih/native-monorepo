...
import id.co.nativeapp.carwash.payment.service.PaymentChargeSucceededService;
 ...
 * record and delegates the carwash-or-skip decision, the ticket lookup, the amount/currency
 ...
 * id.co.nativeapp.carwash.loyaltyref.messaging.GiftCardStateChangedListener} / {@link
 * id.co.nativeapp.carwash.entitlement.messaging.EntitlementEventListener} EXACTLY (carwash's
 * established consumer idiom).
 *
