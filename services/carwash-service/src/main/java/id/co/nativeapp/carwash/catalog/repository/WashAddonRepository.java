...
/**
 * Spring Data repository for {@link WashAddon}. Carries no manual {@code WHERE company_id}: every
 ...
 */
public interface WashAddonRepository extends JpaRepository<WashAddon, UUID> {
