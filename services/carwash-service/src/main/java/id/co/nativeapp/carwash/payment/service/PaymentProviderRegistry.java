...
/**
 * Selects the {@link PaymentProvider} for a tender (ported verbatim from restaurant-service's
 * {@code payment} feature). Built from every {@link PaymentProvider} bean on the classpath, so
 * wiring a real QRIS/card adapter (ADR 0007) is just a new bean — no edit here.
 */
@Component
