...
import id.co.nativeapp.carwash.promotion.projection.AppliedPromotionView;
 ...
 * company_id} is required. Ported from restaurant-service, adapted to {@code ticket_id} in place of
 * {@code order_id}.
 */
