...
/**
 * Wires the ADR 0049 P4 operator-session signing key for carwash-service — the OFFLINE VERIFIER
 ...
 * this is the key carwash-service trusts to attribute a sale's seller (and therefore its
