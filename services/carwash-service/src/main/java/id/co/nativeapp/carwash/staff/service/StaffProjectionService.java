package id.co.nativeapp.carwash.staff.service;
 ...
 * {@link TenantContext#callAs} with a fixed {@code "carwash-staff-consumer"} actor (which lands in
 * the Auditable {@code created_by}), then delegates to the proxied {@link StaffProjectionWriter} so
...
public class StaffProjectionService {
  ...
  public static final String CONSUMER_ACTOR = "carwash-staff-consumer";
