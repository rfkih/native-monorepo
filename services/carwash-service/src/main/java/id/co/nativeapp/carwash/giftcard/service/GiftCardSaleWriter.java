...
import id.co.nativeapp.carwash.config.GiftCardProperties;
...
public class GiftCardSaleWriter {
   ...
   * @throws id.co.nativeapp.carwash.outletref.domain.OutletNotAssignedException if the cashier is
   *     not assigned to {@code request.businessId()} (403)
   * @throws id.co.nativeapp.carwash.giftcard.domain.GiftCardMintLimitExceededException if {@code
