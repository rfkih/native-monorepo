 ...
 *       id.co.nativeapp.carwash.promotion.domain.PromoRuleType}).
 * </ul>
 *
 ...
 *     ({@code CATEGORY} is schema-legal but never matches for carwash — no category dimension)
 * @param scopeRefId the {@code wash_package}/{@code wash_addon} id; required for {@code
