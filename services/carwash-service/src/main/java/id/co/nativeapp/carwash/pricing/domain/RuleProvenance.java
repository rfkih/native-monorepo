 ...
 * flagging from {@code employee-service} (and the restaurant-service {@code pricing} feature this
 ...
 *
 * <p><strong>SME NOTE: the carwash tax/service-charge regime is ILLUSTRATIVE only.</strong> Whether
 * a car-wash sale is subject to PPN (national VAT, currently 11%), a regional service tax, or both,
 * and whether a service charge applies at all, is SME-gated — an accounting + tax SME must confirm
 * the correct regime, rate(s), and tax-base composition before any seeded value is used for
 * regulatory reporting. NEVER deploy the seeded values as fact.
 */
