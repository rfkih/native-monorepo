package id.co.nativeapp.carwash.staff.messaging;

import id.co.nativeapp.carwash.staff.dto.StaffProjectedEvent;
import id.co.nativeapp.carwash.staff.dto.StaffProjectedEvent.Kind;
...
/**
 * Loads carwash-service's CONSUMER copies of the {@code EmployeeChanged} / {@code
 ...
 * Schema Registry serde. carwash-service owns its own consumer view of each contract (full name
...
public final class StaffEventSchemas {
  ...
  /** The parsed reader schema for {@code EmployeeChanged} (carwash's consumer copy). */
  public static Schema employeeSchema() {
    return Holder.EMPLOYEE_SCHEMA;
  }

  /** The parsed reader schema for {@code AssignmentChanged} (carwash's consumer copy). */
