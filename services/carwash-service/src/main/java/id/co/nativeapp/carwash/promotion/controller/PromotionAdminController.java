package id.co.nativeapp.carwash.promotion.controller;
...
/**
 * {@code /api/v1/carwash/promotions[/coupons]} — admin CRUD for the Phase-3 promotions engine (ADR
 * 0026). The tenant ({@code company_id}) and actor come from the bound {@link
 ...
 * /api/v1/promotions/**}).</strong> Restaurant's promotions admin endpoints ride the gateway's
