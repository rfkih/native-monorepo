 ...
 * already {@code CAPTURED} (the idempotent-replay case, handled separately with no error) nor
 * {@code PENDING} (the only capturable state in this phase). Maps to {@code 409 Conflict} via
