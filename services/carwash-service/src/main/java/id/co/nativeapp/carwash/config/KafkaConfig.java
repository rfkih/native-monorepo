...
/**
 * Kafka consumer wiring for carwash-service's listeners — the {@code EntitlementGranted}/{@code
 ...
 * employee-service / finance-service use.
 *
...
public class KafkaConfig {
  ...
  /**
   * The typed listener container factory the carwash {@code @KafkaListener}s bind to: keys are
