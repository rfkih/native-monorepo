 ...
 * through (the {@code X-Roles} header only exists behind the gateway, so a real cashier is always
 * denied; a headerless request is the gateway-less dev recipe or a direct service-layer test).
 */
