package id.co.nativeapp.carwash.outletref.repository;
 ...
 * user → outlet assignments used for the future ticket write-path enforcement (ported verbatim from
 * restaurant-service's {@code outletref} feature).
 *
