 ...
 *
 * <p>Enforce-only for carwash: unlike restaurant-service, the ticket's commission-metric subject
 * stays the washer ({@code StaffProfile}) — this guard does NOT thread the operator anywhere, it
 ...
 *
 * <p>A normal {@code actor_type=user} login (owner/manager/attendant ringing directly, no operator
