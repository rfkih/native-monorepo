...
/**
 * Loads carwash-service's CONSUMER copy of the {@code PaymentChargeSucceeded} Avro schema from the
 * classpath ({@code avro/PaymentChargeSucceeded.avsc}, the single {@code libs/contracts} source of
 * truth, ADR 0003/0045) and decodes raw Avro bytes into a {@link PaymentChargeSucceededEvent}.
 */
public final class PaymentChargeSucceededConsumerSchema {
  ...
  public static PaymentChargeSucceededEvent decode(UUID eventId, byte[] payload) {
    ...
    Object referenceId = record.get("reference_id");
    Object providerTxnId = record.get("provider_txn_id");
    return new PaymentChargeSucceededEvent(
        ...
        referenceId == null ? null : UUID.fromString(referenceId.toString()),
        ...
        providerTxnId == null ? null : providerTxnId.toString(),
