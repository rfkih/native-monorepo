 ...
 * id is a {@link id.co.nativeapp.carwash.promotion.domain.PromoRuleValidationException} (422).
 *
 * @param code the redemption code (case-insensitive; normalized to uppercase)
 * @param ruleId the {@link id.co.nativeapp.carwash.promotion.domain.PromoRule} this coupon redeems
 *     — may be of ANY rule type, including a {@code requires_coupon = TRUE} one
