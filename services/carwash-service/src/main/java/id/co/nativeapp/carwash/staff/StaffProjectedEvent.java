 ...
 * StaffProjectionService}. An immutable record carrying the event id (for idempotency), the owning
 * tenant the consumer binds the write to, the employee id (the projection key), the event kind, and
