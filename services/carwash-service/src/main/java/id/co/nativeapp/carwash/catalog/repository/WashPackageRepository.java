...
/**
 * Spring Data repository for {@link WashPackage}. Carries no manual {@code WHERE company_id}: every
 ...
 */
public interface WashPackageRepository extends JpaRepository<WashPackage, UUID> {

  /**
   * Lists packages, optionally filtered by {@code businessId} and/or restricted to active-only,
  ...
  /**
   * Batch-loads packages by id, projected — used by the ticket checkout item-resolution path.
