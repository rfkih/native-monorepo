package id.co.nativeapp.carwash.metric.messaging;
 ...
 * aggregate id is the {@code source_business_id} (the carwash outlet).
 */
public final class MetricPublishedSchema {
   ...
   *
   * @param metricKey the metric this measures (e.g. {@code wash_count})
   ...
   * @param sourceBusinessId the carwash outlet the metric originated from (UUID as string)
   */
