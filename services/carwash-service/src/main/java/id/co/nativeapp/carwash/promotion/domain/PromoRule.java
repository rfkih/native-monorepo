 ...
 * id.co.nativeapp.carwash.promotion.service.PromotionEngineService PromotionEngineService} resolves at
 * checkout/quote time. Maps to the {@code promo_rule} table (V8__promotions.sql). Ported verbatim
 * from restaurant-service (identical DDL, identical entity shape).
 *
