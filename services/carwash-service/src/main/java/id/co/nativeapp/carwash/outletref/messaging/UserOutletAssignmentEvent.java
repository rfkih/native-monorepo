 ...
 * into {@code user_outlet_assignment_ref} (ported verbatim from restaurant-service's {@code
 * outletref} feature). Immutable record; carries only what the consumer needs.
 *
 ...
 * @param assignmentId the org-service assignment row PK; used as the carwash table PK on insert
