...
/**
 * The payment-tender port (ADR 0006), ported verbatim from restaurant-service's {@code payment}
 * feature. One implementation per rail, selected by tender via {@link PaymentProviderRegistry}, so
 * a real payment-service-provider is added as one new bean (ADR 0007) with no {@code switch} to
 * touch.
 *
