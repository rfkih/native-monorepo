 ...
 * promo_rule.rule_type} database CHECK constraint (V8) already allows it — the supporting columns
 ...
 * id.co.nativeapp.carwash.promotion.service.PromotionEngineService PromotionEngineService} ships
