-- carwash-service V9 — Phase 4 of the POS-parity program (ADR 0027: loyalty-service and
...
-- SaleRecorded emission. Identical DDL to restaurant-service V17 — only this header and the trailing
-- ALTER's target table (carwash_ticket, not restaurant_order) differ.
--
-- ---------------------------------------------------------------------------
...
--
-- ---------------------------------------------------------------------------
-- General notes (mirrors V7 user_outlet_assignment_ref precedent)
-- ---------------------------------------------------------------------------
...
--     CHECK), identical predicate to every other carwash-service table.
...
-- carwash_ticket_line.item_id-style snapshots.
...
-- ---------------------------------------------------------------------------
-- carwash_ticket — nullable, additive checkout columns for a loyalty/gift-card redemption
-- ---------------------------------------------------------------------------
