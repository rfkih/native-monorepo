...
/**
 * Test fixtures for publishing the events carwash-service consumes the way the producer + Debezium
 * would: raw Avro bytes (built via {@code libs/events AvroSerde}) as the message value, the
 ...
 * transport carwash-service consumes in production.
 */
