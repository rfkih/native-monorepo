 ...
 * restaurant-service's {@code GiftCardSoldContractTest} (SaleRecordedContractTest's per-service
 * pattern). carwash-service is one of THREE producers sharing the one stable {@code
 * id.co.nativeapp.events.restaurant} namespace (EVENT-CATALOG.md "namespace decision").
 */
