 ...
 * the producer, carwash-service one of three vertical consumers. Mirrors {@code
 * GiftCardStateChangedContractTest} exactly: the PRODUCER schema is inlined from
 * docs/EVENT-CATALOG.md / {@code payment-service}'s {@code PaymentChargeSucceeded.avsc} and checked
 * mutually backward-compatible with carwash's own consumer copy, both nullable-union fields
