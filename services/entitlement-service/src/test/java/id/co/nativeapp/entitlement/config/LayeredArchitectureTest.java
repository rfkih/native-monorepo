...
class LayeredArchitectureTest {
   ...
   * dto as the boundary-translation layer and projection as the native-query read-model package.
   ...
   * {@code @Configuration}/filter/advice set) and the shared libs are out of scope.
   *
   * <p>Projection holds native-query read models produced by the repository and consumed (mapped to
   * a dto) by the service — reachable from neither the controller nor below (CODE-STRUCTURE §3.3).
   */
  @Test
