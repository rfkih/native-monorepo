 ...
 * id is a {@link id.co.nativeapp.restaurant.promotion.domain.PromoRuleValidationException} (422).
 *
 * @param code the redemption code (case-insensitive; normalized to uppercase)
 * @param ruleId the {@link id.co.nativeapp.restaurant.promotion.domain.PromoRule} this coupon
