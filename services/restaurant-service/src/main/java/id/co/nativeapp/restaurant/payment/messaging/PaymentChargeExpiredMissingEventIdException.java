 ...
 * producer-side contract violation). The {@link id.co.nativeapp.restaurant.config.KafkaConfig} error
 * handler classifies this as <strong>non-retryable</strong>: the record is routed immediately to the
 * topic's {@code .DLT} — fail closed. Mirrors {@link PaymentChargeSucceededMissingEventIdException}
 * exactly.
 */
