 ...
 * {@link TenantContext#callAs} with a fixed {@code "restaurant-entitlement-consumer"} actor (which
 ...
 * the next gate check re-reads the projection loader — promptly opening or closing the gate.
 */
@Service
public class EntitlementProjectionService {

  /** The audit actor for system-driven consumer writes (stamped into {@code created_by}). */
  public static final String CONSUMER_ACTOR = "restaurant-entitlement-consumer";
