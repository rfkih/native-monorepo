package id.co.nativeapp.restaurant.giftcard.service;

import id.co.nativeapp.events.AvroSerde;
import id.co.nativeapp.events.OutboxWriter;
import id.co.nativeapp.money.Money;
import id.co.nativeapp.restaurant.config.GiftCardProperties;
import id.co.nativeapp.restaurant.giftcard.domain.GiftCardCodeGenerator;
import id.co.nativeapp.restaurant.giftcard.domain.GiftCardMintLimitExceededException;
import id.co.nativeapp.restaurant.giftcard.domain.GiftCardSale;
...
public class GiftCardSaleWriter {
   ...
   * @throws id.co.nativeapp.restaurant.outletref.domain.OutletNotAssignedException if the cashier
   *     is not assigned to {@code request.businessId()} (403)
   * @throws id.co.nativeapp.restaurant.giftcard.domain.GiftCardMintLimitExceededException if {@code
