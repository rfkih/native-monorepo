 ...
 * producer-side contract violation). The {@link
 * id.co.nativeapp.restaurant.config.KafkaConfig} error handler classifies this as
 * <strong>non-retryable</strong>: the record is routed immediately to {@code
 * UserOutletAssignmentChanged.DLT} — fail closed.
 */
