 ...
 * is routed immediately to the topic's {@code .DLT} — fail closed, never an infinite in-place retry
 * that blocks the partition. Mirrors {@code
 * outletref.messaging.UserOutletAssignmentDecodeException} exactly.
 */
