 ...
 * id.co.nativeapp.restaurant.promotion.service.PromotionEngineService#evaluate} — carried on {@link
 * id.co.nativeapp.restaurant.promotion.dto.CouponOutcome} and surfaced on the wire as {@code
 * PriceBreakdownResponse.couponStatus}.
 */
