package id.co.nativeapp.restaurant.loyaltyref.repository;
 ...
 * projection (this repository is a plain {@link org.springframework.jdbc.core.JdbcTemplate}
 * wrapper over a read-model table, not a Spring Data JPA repository) — a small internal value type
