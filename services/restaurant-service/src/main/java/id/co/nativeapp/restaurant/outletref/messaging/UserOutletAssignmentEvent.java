 ...
 * into {@code user_outlet_assignment_ref}. Immutable record; carries only what the consumer needs.
 *
 ...
 * @param assignmentId the org-service assignment row PK; used as the restaurant table PK on insert
