 ...
 * checkout with no payment field). Phase 4 (ADR 0027): loyalty/gift-card redemption is likewise
 * evaluated HERE, not at park time (mirrors the promotions posture).
 *
 ...
 * @param loyaltyMemberId Phase 4 (ADR 0027): optional loyalty member to attach; see {@link
 *     CheckoutRequest#loyaltyMemberId()}.
 * @param loyaltyRedeemPoints Phase 4 (ADR 0027): optional points to redeem; see {@link
 *     CheckoutRequest#loyaltyRedeemPoints()}.
 * @param giftCardId Phase 4 (ADR 0027): optional gift card to redeem; see {@link
