 ...
 *
 * <p>This is the moment revenue is recognised for a parked order, and (Phase 3, ADR 0026) the moment
 * promotions are evaluated — a parked order does NOT lock in promotions at park time; they are
 * re-evaluated here, against the rules/coupon effective at THIS instant. The payment field is
 ...
 * @param couponCode Phase 3 (ADR 0026): optional coupon code to redeem at pay time; case-insensitive.
 *     An invalid or exhausted code is rejected ({@code 422}/{@code 409}) — pay-parked is
 *     money-moving, same as checkout.
 */
