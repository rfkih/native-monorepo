 ...
 * truncated Avro, or a schema mismatch). The {@link
 ...
 * is routed immediately to {@code UserOutletAssignmentChanged.DLT} — fail closed, never an infinite
 * in-place retry that blocks the partition.
 */
