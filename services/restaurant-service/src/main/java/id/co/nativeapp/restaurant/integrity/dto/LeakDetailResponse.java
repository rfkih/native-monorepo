 ...
 * @param quantity units missing, sales counted, closes in a run — whatever the signal counts; the
 *     unit is implied by the signal type and named by the client's copy
