 ...
 * restaurant-service maintains this projection by CONSUMING {@code EntitlementGranted}/{@code
 ...
 * id.co.nativeapp.restaurant.entitlement.service.ProjectionEntitlementLoader} the shared {@code
 * libs/entitlement-check} cache consults on a miss, so the self-order-create gate can answer "is
