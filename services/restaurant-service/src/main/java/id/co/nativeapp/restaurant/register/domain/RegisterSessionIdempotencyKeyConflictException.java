 ...
 * standard §1.3: same key + different payload → 409). Prevents a client bug from silently masking
 * a changed drawer count or a cross-outlet key reuse behind a 200 replay. Mapped to {@code 409
