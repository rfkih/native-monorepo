...
/**
 * Loads restaurant-service's consumer view of the org-service {@code UserOutletAssignmentChanged}
 ...
 * initializer, to avoid {@code ExceptionInInitializerError} flakiness in partial test runs. The
 * pattern mirrors {@link id.co.nativeapp.finance.orgref.messaging.OrgUnitRefSchemas}.
 */
