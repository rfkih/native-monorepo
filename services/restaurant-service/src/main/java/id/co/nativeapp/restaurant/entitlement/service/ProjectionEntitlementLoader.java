...
/**
 * restaurant-service's projection-backed {@link EntitlementLoader} — the authoritative fallback the
...
public class ProjectionEntitlementLoader implements EntitlementLoader {
  ...
  static final String LOADER_ACTOR = "restaurant-entitlement-loader";
