...
/**
 * Read projection for the list endpoint: a bill summary with its running total (sum of line totals)
 * and line count. Does NOT include line details — use {@link BillView} + {@link BillLineView} for
 * the detail view.
 *
