...
class LayeredArchitectureTest {
  ...
  private static final String BASE_PACKAGE = "id.co.nativeapp.restaurant";
  ...
  void featureLayersRespectTheLayeredArchitecture() {
    ArchRule rule =
        layeredArchitecture()
            ...
            // Messaging is feature-local event plumbing reached only from the service layer
            // (SaleWriter builds the SaleRecorded GenericRecord via SaleRecordedSchema); no
