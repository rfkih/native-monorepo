 ...
 * {@code id.co.nativeapp.finance.labor.messaging.ReversalEventIds}). A consolidation id MUST NOT
 * collide with that, nor with another group's / period's / close-run's consolidation id. Two
 ...
 */
public final class ConsolidationEntryIds {
   ...
   */
  public static UUID forElimination(
   ...
   */
  public static UUID forReversal(UUID groupId, String period, int closeRunSeq, UUID priorEntryId) {
    String name =
        REVERSAL_PREFIX
            + groupId
            + ":"
   ...
   * idempotent.
   */
  public static UUID forCta(UUID groupId, String period, int closeRunSeq) {
   ...
   */
  public static UUID forFxTranslationDiff(
      UUID groupId, String period, int closeRunSeq, String intercompanyRef) {
    String name =
   ...
   */
  public static UUID forConsolidationClosedEmit(UUID groupId, String period, int closeRunSeq) {
