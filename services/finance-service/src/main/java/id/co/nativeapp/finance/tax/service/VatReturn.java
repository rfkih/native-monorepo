 ...
 * negative in a net-void period (voids exceeded issues); the file path rejects that. Internal to the
 * tax service (the reader's raw computation, before the filing-state overlay).
 */
