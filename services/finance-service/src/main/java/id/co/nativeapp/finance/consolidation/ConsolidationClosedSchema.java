 ...
 * same approach as {@link id.co.nativeapp.finance.group.GroupDefinedSchema} (a producer) and the
 * finance consumer schemas. The notification-service consumer keeps its own back-compatible copy;
 * its {@code ConsolidationClosedContractTest} asserts the two stay compatible (rule 7).
 *
