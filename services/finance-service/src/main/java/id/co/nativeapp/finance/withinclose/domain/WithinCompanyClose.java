 ...
 * id.co.nativeapp.finance.consolidation.domain.ConsolidationSummary} (the GROUP close). Creating it
 * is what makes the close emit {@code ConsolidationClosed(group_id = null)} and a {@code
