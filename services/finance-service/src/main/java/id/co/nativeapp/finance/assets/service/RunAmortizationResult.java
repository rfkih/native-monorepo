...
/**
 * The outcome of {@link AmortizationRunWriter#run}: the run id and whether this call FRESHLY ran
 * the period ({@code created == true}) or found an already-run period and no-oped ({@code created
