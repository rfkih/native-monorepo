...
/**
 * The outcome of one group-close attempt (P3d SEAM 3a) — the {@link ConsolidationState} the close
 * landed in, the summary row id it wrote (or superseded into), and the close run sequence.
 *
 * <p>A {@link ConsolidationState#CLOSED} result means the consolidation finalised; any other state
 * is a GATED outcome (the close held back loudly — pending members, a multi-currency group,
 * unreconciled intercompany, or a warming-up member projection). {@code firstRun} is {@code false}
