 ...
 * 404} with a generic detail — a foreign-tenant id is indistinguishable from a missing one, so
 * there is no existence disclosure (mirrors {@code BillNotFoundException} / {@code
