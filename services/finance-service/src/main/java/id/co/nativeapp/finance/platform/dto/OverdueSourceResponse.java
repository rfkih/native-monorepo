 ...
 * loudest case: money has been accruing since the first sale and nothing has ever come back.
 * {@code cadenceDays} is the threshold it was judged against, so the console can say why it is
 * being asked rather than just that it is.
 */
