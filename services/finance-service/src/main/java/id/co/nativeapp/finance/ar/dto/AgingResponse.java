...
/**
 * API response for the AR aging report as of a date. Outstanding balances are bucketed by
...
public record AgingResponse(
  ...
  /**
   * One customer's aged outstanding balance. {@code outstandingMinor} is the sum of the buckets.
   */
  ...
  /** The column totals across all customers. */
