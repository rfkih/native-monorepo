 ...
 * GroupCloseWriter}.
 */
public final class SimplifiedTranslationPolicy {
   ...
   */
  public static final String CTA_TRANSLATION_RESERVE_ACCOUNT = "3950-CTA-TRANSLATION-RESERVE";

  /**
   * The consolidation account a cross-currency intercompany residual ({@link
   * ConsolidationEntryType#FX_TRANSLATION_DIFF}) posts to.
   */
  public static final String FX_TRANSLATION_DIFF_ACCOUNT = "3960-FX-TRANSLATION-DIFF";
