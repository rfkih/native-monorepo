 ...
 * id.co.nativeapp.finance.revenue.domain.MoneyEmbeddable}s, which would carry three redundant
 * currency columns). {@link #groupRevenue()} / {@link #groupExpense()} / {@link #groupNet()}
 * reconstruct the {@link Money} value type (rule 8 — integer minor units + ISO-4217, never a
 * float).
 *
