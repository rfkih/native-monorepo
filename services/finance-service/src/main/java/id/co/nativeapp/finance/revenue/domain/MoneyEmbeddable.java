 ...
 * CHAR(3)} (the ledger), and is reused for {@code total_minor} + {@code currency} on the
 * consolidated-revenue read model; it carries no floating-point field at all.
 *
 ...
 * protected ctor; application code should prefer {@link #of(Money)}.
 */
@Embeddable
