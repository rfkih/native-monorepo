 ...
 *   <li>{@link #MULTI_CURRENCY_UNSUPPORTED} — a member's base currency differs from the reporting
 *       currency. FX translation is SEAM 3b; 3a rejects this cleanly rather than summing mixed
 *       currencies (which {@code Money.plus} would throw on anyway).
