...
| [0077](0077-neutral-ink-brand-replaces-deep-cyan.md) | Neutral ink replaces the deep-cyan brand fleet-wide — primary is maximum contrast against the page and inverts on dark, the three-shade rule retires, green still means profit only | Proposed |
| [0078](0078-the-phone-more-surface-is-a-screen.md) | The phone's "More" surface is a screen, not a modal — a phone login's only navigation gets a route, a history entry and its scroll position back (amends [0075](0075-navigation-and-overlay-contract.md)) | Proposed |
